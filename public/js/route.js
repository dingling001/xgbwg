        ...
        initMarkers: function () {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    api_token: 'f9fdbdc97c02f36cc556665c73993020',
                    language: 1,
                    skip: 0,
                    take: 1000
                },
                success: function (res) {
                    ...
                    if (res.status == 1 && res.data.length) {
                        ...
                        vm.isLoad = true;
                        vm.menus = res.data;
                        vm.lists = res.data[vm.ind].exhibit_list;
                        vm.map_path = res.data[vm.ind].map_path;
                        var len = res.data[vm.ind].exhibit_list.length;
                        for (var i = 0; i < len; i++) {
                            var d = vm.lists[i];
                            ...
                            var myIcon = new L.divIcon({
                                ...
                                html: "<div class='cell' data_id='" + d.exhibit_id + "'><div class='cell_icon'><img src='" + d.img + "'></div><div class='cell_title' style=''>" + d.title + "</div></div>"
                            });
